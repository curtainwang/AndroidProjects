package com.android.binderservicedemo;
...
public class MainActivity extends Activity {
	...
	// We'll call methods belonging to this instance to communicate with the
	// Service
	...
	protected void onStart() {
		...
		Intent intent = new Intent(this,
				com.example.testbinderservice.LocalService.class);
